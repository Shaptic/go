...
// transaction is a V0 envelope (aka before preconditions existed, this crafts a
// timebound precondition). If the transaction is a fee bump, it returns the
// preconditions of the *inner* transaction.
