...
* `AllowTrustOp` now fills in the asset issuer from the source account when parsing from raw XDR whenever possible ([#3650](https://github.com/stellar/go/pull/3650)).
